...
#define STRING_CONFIG_H_AUTHOR "(luxwarp)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Winice M09 MKS TinyBee"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 84.06
  #define DEFAULT_bedKi 15.88
  #define DEFAULT_bedKd 296.61
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.22 , 76.9 , 403.6, 103 }
